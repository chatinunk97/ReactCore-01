const ArrayPost = [
    { id: 1, message: "Have you heard of Joe ?", date: "23 Aug 2023", poster: "ymd" , profilePic : "http://m.gettywallpapers.com/wp-content/uploads/2023/07/Pfp-Boku-no-Kokoro-no-Yabai-Yatsu.jpg"},
    ...
    return (
        <div className="post">
            <div className="left">
                ...
                <p>Post By : {`${prop.post.poster}`} <br></br></p>
            </div>
            <div className="right">
                <img src={`${prop.post.profilePic}`}></img>
                <p> Date : {`${prop.post.date}`} </p>
            </div>
        </div>
    )
}
